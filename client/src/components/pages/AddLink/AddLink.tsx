        ...
        <SectionContainer>
            <FormProvider {...methods}>
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <TextArea  onChange={(e:React.ChangeEvent<HTMLInputElement>) => handleLinkUpload(e.target.value)} label='Upload links here, simply paste in whatever you want and click upload.' />
                {parsedLinkText?.map((link: any) => <p>{link}</p>) }
