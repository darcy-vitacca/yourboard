...
export const LandingPage = () => {
  ...
  return (
    <>
      ...
      <LandingSectionContainer>
        <LandingCTAContainer>
          <Markdown children=" **urboard** is a personal dashboard designed to help you **navigate the web easier**, across all your devices. Manage your favorite links/bookmarks **all in one place and navigate faster to what matters most**. Collaborate with friends and organize your projects, ideas, and inspiration in one place. " />
          <div>
            <Markdown
              children="
