...
const linkController = __importStar(require("../components/link/controller"));
...
module.exports = (app) => {
    app.route('/api/link/:project').post(user_1.default, auth_1.default, linkController.createLink);
};
